...
export default defineNuxtConfig({
  css: ['@/assets/css/base.css', '~/assets/css/fonts.css', '~/assets/css/tailwind.css', '~/assets/css/app.css', '~/assets/css/main.css', '~/assets/css/tokens.css', '~/assets/css/utilities.css'],
